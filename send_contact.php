...
//my email
$address = "sutainnocent@gmail.com";
$fullName = $Fname .' '. $Lname;


$e_subject = $Subject;

$e_body = "You have been contacted by $fullName. Their additional message is as follows." . PHP_EOL . PHP_EOL;
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<p>Thank you <strong>$fullName</strong>, your message has been submitted to Me.</p>";
	echo "</div>";
	echo "</fieldset>";
